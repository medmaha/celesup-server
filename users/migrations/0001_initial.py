    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(default='default-avatar.png', max_length=300)),
                ('cover_img', models.CharField(default='default-cover_img.png', max_length=300)),
                ('email', models.EmailField(max_length=160, unique=True)),
                ('name', models.CharField(blank=True, max_length=255, null=True)),
                ('username', models.CharField(max_length=100, unique=True)),
                ('secret_token', models.CharField(blank=True, max_length=160, null=True)),
